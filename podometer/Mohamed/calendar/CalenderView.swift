...
//  BrodcastWebRTC
//
//  Created by DENNOUN Mohamed on 25/09/2020.
...
class CalenderView: UIView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, MonthViewDelegate {
    ...
    func initializeView() {
        ...
        installDay = Calendar.current.component(.day, from: getInstalationDate())
        installMounth = Calendar.current.component(.month, from: getInstalationDate())
        installYear = Calendar.current.component(.year, from: getInstalationDate())
